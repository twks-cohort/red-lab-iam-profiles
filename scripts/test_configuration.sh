...
aws-vault exec tjriceepc --no-session -- aws sts assume-role --output json --role-arn arn:aws:iam::${AWS_ACCOUNT_ID}:role/DPSIamProfilesRole --role-session-name awspec-test > credentials
